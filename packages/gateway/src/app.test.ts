...
describe("gateway", () => {
  ...
  it("falls back to the default repo when the override names an unknown repo", async () => {
    const memoryRoot = mkdtempSync(join(tmpdir(), "gateway-slack-default-fallback-"));
