...
| D5  | `interrupt` defaults to false (safe by default)      | New sources should not interrupt running sessions unless explicitly opted in. Only Slack mentions and GitHub @mentions set `interrupt: true`.                                                                                                                                                 |
