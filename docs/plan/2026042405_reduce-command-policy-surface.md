...
| PR read          | `gh pr view [<number>] ...`, `gh pr diff [<number>] ...`, `gh pr list ...`, `gh pr checks [<number>] ...`, `gh pr status` | No URL or branch selector support in Phase 1                                                                                                                                |
| issue read       | `gh issue view <number> ...`, `gh issue list ...`                                                                         | Numeric issue selector only                                                                                                                                                 |
| repo read        | `gh repo view ...`                                                                                                        | Current repo by default; optional `-R/--repo` only if explicitly retained in implementation                                                                                 |
| run read         | `gh run list ...`, `gh run view <id> ...`, `gh run watch <id> ...`                                                        | Current repo only                                                                                                                                                           |
| workflow read    | `gh workflow list ...`, `gh workflow view <workflow> ...`                                                                 | Current repo only                                                                                                                                                           |
...
- `blocks gh pr checkout with a git worktree hint`
