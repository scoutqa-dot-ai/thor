...
| `GIT_CLONE_ALLOWED_URL_PREFIXES`    | No       | `remote-cli`                         | Comma-separated HTTPS GitHub URL prefixes allowed for `git clone`; use trailing slashes. Thor derives `/workspace/repos/<repo>` destinations |
