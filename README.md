...
| `LANGFUSE_HOST`                 | No       | `remote-cli`                | Langfuse MCP host URL; all three `LANGFUSE_*` vars required to enable Langfuse, must be https (fails fast otherwise), no per-profile override |
