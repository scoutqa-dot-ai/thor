...
| `LANGFUSE_BASE_URL`             | No       | `remote-cli`                | Langfuse MCP base URL; all three `LANGFUSE_*` vars required to enable Langfuse, must be https (fails fast otherwise); profile variants use `_<PROFILE_NAME>` suffixes |
