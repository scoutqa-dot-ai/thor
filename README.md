...
| `ATLASSIAN_CLOUD_ID`             | No          | `remote-cli`                   | Atlassian cloud ID; required with auth to enable Atlassian; injected server-side into outbound MCP calls; profile suffixes are MCP-only     |
